...
/** @brief Client command that reset the device but not leave network.
 *
 * Cluster: Basic, Attributes for determining basic information about a device, setting user device information such as location, and enabling a device.
 * Command: tuya_ext_reset
 */
#define emberAfFillCommandBasicClustertuya_ext_reset() \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_BASIC_CLUSTER_ID, \
                            ZCL_TUYA_EXT_RESET_COMMAND_ID, \
                            "");
...
/** @name Vancount Configuration Cluster Commands */
// @{
/** @} END Vancount Configuration Cluster Commands */
