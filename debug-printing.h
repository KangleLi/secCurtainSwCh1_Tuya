...
// Printing macros for cluster: Vancount Configuration Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_VC_MFG_SYS_CONFIG_CLUSTER)
#define emberAfVcMfgSysConfigClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_VC_MFG_SYS_CONFIG_CLUSTER, __VA_ARGS__)
#define emberAfVcMfgSysConfigClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_VC_MFG_SYS_CONFIG_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfVcMfgSysConfigClusterFlush()
#define emberAfVcMfgSysConfigClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_VC_MFG_SYS_CONFIG_CLUSTER) ) { x; }
#define emberAfVcMfgSysConfigClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_VC_MFG_SYS_CONFIG_CLUSTER, (buffer), (len), (withSpace))
#define emberAfVcMfgSysConfigClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_VC_MFG_SYS_CONFIG_CLUSTER, (buffer))
#else
#define emberAfVcMfgSysConfigClusterPrint(...)
#define emberAfVcMfgSysConfigClusterPrintln(...)
#define emberAfVcMfgSysConfigClusterFlush()
#define emberAfVcMfgSysConfigClusterDebugExec(x)
#define emberAfVcMfgSysConfigClusterPrintBuffer(buffer, len, withSpace)
#define emberAfVcMfgSysConfigClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_VC_MFG_SYS_CONFIG_CLUSTER)
