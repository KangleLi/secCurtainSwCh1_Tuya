...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 205 --manuf-id 0x1254 --image-type 0x0301 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL ShadeDeviceForOne"':
        sys.exit(0)
    print " "
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 205 --manuf-id 0x1254 --image-type 0x0301 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL ShadeDeviceForOne"'.replace("\t", "\\t")
